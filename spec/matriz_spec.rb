...
describe Matriz do
  ...
  before :each do
    ...
    @m5 = Matriz.new([[Fraccion.new(1, 2), Fraccion.new(3, 5)], [Fraccion.new(3, 4), Fraccion.new(2, 3)]])
    @m6 = Matriz.new([[Fraccion.new(3, 2), Fraccion.new(1, 5)], [Fraccion.new(5, 4), Fraccion.new(1, 3)]])
  end
  ...
  describe "Operaciones con dos matrices" do
    it "Se deben poder sumar dos matrices" do
      ...
      ((@m5 + @m6).matriz.should == Matriz.new([[Fraccion.new(2, 1), Fraccion.new(4, 5)], [Fraccion.new(2, 1), Fraccion.new(1, 1)]]).matriz)
    end
